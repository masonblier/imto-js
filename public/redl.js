...
(function() {
  ...
  Lexer = function(str) {
    var LexerClass;
    LexerClass = (function() {
      var at, c, formatBlockSource, input, memo_idx, memos, next_token, replaceSpecials, special;
      ...
      function LexerClass(str) {
        this.cursor = __bind(this.cursor, this);
        c = 0;
        input = str;
        replaceSpecials();
      }
      ...
      LexerClass.prototype.cursor = function() {
        var CursorClass;
        CursorClass = (function() {
          ...
          CursorClass.prototype.next = function(i) {
            if (i == null) {
              i = 1;
            }
            return at(idx += i);
          ...
          CursorClass.prototype.back = function(i) {
            if (i == null) {
              i = 1;
            }
            return at(idx -= i);
          ...
          CursorClass.prototype.peek = function(i) {
            if (i == null) {
              i = 1;
            }
            return at(idx + i);
          ...
          CursorClass.prototype.prev = function(i) {
            if (i == null) {
              i = 1;
            }
            return at(idx - i);
