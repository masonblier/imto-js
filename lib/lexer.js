...
(function() {
  ...
  module.exports = Lexer = (function(_super) {
    ...
    Lexer.prototype.next_token = function() {
      var boundary, buffer, c, cc, i, indent, line, lookahead, source, stack, tracking_start, type, ws, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref24, _ref25, _ref26, _ref27, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      buffer = '';
      cc = this.char_cursor;
      ws = 1;
      ...
      if (cc.peek().char === "#") {
        while (c = (_ref26 = cc.next()) != null ? _ref26.char : void 0) {
          if (c === "\n") {
            break;
          }
          buffer += c;
      ...
      if ((_ref27 = cc.peek().char) === "]" || _ref27 === ")" || _ref27 === "}") {
