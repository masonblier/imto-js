...
(function() {
  ...
  module.exports = Lexer = (function(_super) {
    ...
    Lexer.prototype.next_token = function() {
      ...
      if ((_ref21 = cc.peek().char) === "'" || _ref21 === '"') {
        boundary = cc.next().char;
        while ((cc.peek() != null) && ((_ref23 = cc.peek()) != null ? _ref23.char : void 0) !== boundary) {
          buffer += cc.next().char;
          if (((_ref22 = cc.peek()) != null ? _ref22.char : void 0) === "\\") {
            buffer += cc.next().char;
            buffer += cc.next().char;
          }
        }
        if (((_ref24 = cc.next()) != null ? _ref24.char : void 0) === boundary) {
          return {
            type: "string",
      ...
      if (cc.peek().char === "#") {
        while (c = (_ref25 = cc.next()) != null ? _ref25.char : void 0) {
          if (c === "\n") {
            break;
          }
          buffer += c;
