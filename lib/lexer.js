...
(function() {
  ...
  module.exports = Lexer = (function(_super) {
    ...
    function Lexer(input) {
      ...
      Lexer.__super__.constructor.call(this, this);
      this.char_index = 0;
      this.memo_index = -1;
      this.memos = [];
      this.linestart = true;
    ...
    Lexer.prototype.next_token = function() {
      var boundary, buffer, c, indent, line, lookahead, source, stack, type, ws, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      buffer = '';
      if (this.char_cursor.indent(this.char_index) > this.indent && this.input[this.char_index] !== "\n") {
        console.log("matching indent");
