...
(function() {
  var BlockNode, Cursor, ImtoError, Lexer, ParseError, Parser, precedence, printNode, _ref,
  ...
  _ref = require('./utils'), printNode = _ref.printNode, ImtoError = _ref.ImtoError;
  ...
  module.exports = Parser = (function(_super) {
    ...
    Parser.prototype.statement = function() {
      var expr, _ref1;
      while (((_ref1 = this.lexer.peek()) != null ? _ref1.type : void 0) === "linefeed") {
        this.lexer.next();
      }
      if (expr = this.expr()) {
    ...
    Parser.prototype.tidbit = function() {
      var expr, _ref1, _ref2;
      if ((_ref1 = (_ref2 = this.lexer.peek()) != null ? _ref2.type : void 0) === 'comma' || _ref1 === 'linefeed' || _ref1 === 'operator') {
        return void 0;
      }
      if (!expr) {
    ...
    Parser.prototype.block = function() {
      var n, subject, _ref1, _ref2, _ref3;
      if (((_ref1 = this.lexer.peek()) != null ? _ref1.type : void 0) === "block") {
      ...
      if (((_ref2 = this.lexer.peek()) != null ? _ref2.type : void 0) === "linefeed") {
        if (((_ref3 = this.lexer.peek(2)) != null ? _ref3.type : void 0) === "block") {
    ...
    Parser.prototype["function"] = function() {
      var node, subject, _ref1;
      if (((_ref1 = this.lexer.peek()) != null ? _ref1.type : void 0) === "function") {
        subject = this.lexer.next();
        node = this.expr();
        return {
          type: "function",
    ...
    Parser.prototype.hash_assignment = function() {
      var first, n, node, statements, subject, _ref1, _ref2, _ref3;
      if (((_ref1 = this.lexer.peek()) != null ? _ref1.type : void 0) === "symbol") {
        n = this.lexer.peek(2);
        if ((n != null ? n.token : void 0) === ":") {
          ...
          if (((_ref2 = this.lexer.peek()) != null ? _ref2.token : void 0) === ',') {
            statements = [first];
            while (((_ref3 = this.lexer.peek()) != null ? _ref3.token : void 0) === ',') {
              this.lexer.next();
