...
(function() {
  ...
  module.exports = Parser = (function(_super) {
    ...
    Parser.prototype.expr = function(subject) {
      var expr, node, operator, _ref;
      expr = this.tidbit(subject);
      if ((expr != null) && ((_ref = this.lexer.peek()) != null ? _ref.type : void 0) === "operator") {
        operator = this.lexer.next().token;
    ...
    Parser.prototype.tidbit = function(subject) {
      var expr;
      expr = this.block(subject) || this["function"](subject) || this.assignment(subject) || this.execute(subject) || subject;
      return expr;
    };
